...
## 後續發展(2006 之後;見 docs/literature/1_lineage_map)
...
## 引用 Weber 2006 的後續延伸(見 docs/literature/2_weber2006_citations)
...
- **Dequidt, J.; Courtecuisse, H.; Comas, O.; et al.** (2013). *Computer-based training system for cataract surgery.* → SOFA + GPU 即時 FEM(見 docs/literature/3_inria_fem_lineage)。
